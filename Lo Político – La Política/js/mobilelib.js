...
dhbgApp.mobile.start = function() {
    ...
    var $close_menu = $('<div id="close_menu" class="button"><i class="ion-chevron-right"></i></div>');
    $close_menu.on('click', function() { $box_menu.hide( { effect: 'slide', direction: 'right' } ); });
    $box_menu.append($close_menu);

    var $open_menu = $('<div id="open_menu" class="button"><i class="ion-chevron-left"></i></div>');
    ...
    $('.box-text').each(function(){
        ...
        if ($this.attr('label')) {
            var $box_title = $('<div class="title"><div class="text">' + $this.attr('label') + '</div></div>');
    ...
    $('.ctrl-pagination').each(function() {
        ...
        var id = $this.attr('id');
        if (!id) {
            id = 'ctrl-pagination-' + dhbgApp.rangerand(0, 1000, true);
            $this.attr('id', id);
        }
        ...
        $items.each(function(){
            ...
            if (numeric_pagination) {
                var $new_button = $('<li class="button"><a href="#' + id + '"><div>' + label + '</div></a></li>');
